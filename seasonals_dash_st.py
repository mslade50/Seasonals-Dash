...
def seasonals_chart(tick):
	...
	this_yr_end=dt.datetime(2023,5,3)
	...
	annotations.append(
		create_annotation(1.02, 1.12, f"Concordance 5,10,21: {sign_agreement_1d,sign_agreement_5d,sign_agreement_10d,sign_agreement_21d}", 'white')
	)
	fig.update_layout(
...
positions=['^GSPC','SPY','MLCO','cl=f','EURUSD=X','HAE','DX-Y.NYB','^VIX','ZW=F','SIG']
positions.sort()
